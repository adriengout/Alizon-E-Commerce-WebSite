...
create table _stock(
  ...
  create table _reassort(
      ...
      date_reassort timestamp default current_timestamp,
      commentaire varchar(255),
      constraint _reassort_pk primary key(id_reassort),
      constraint _reassort_fk_produit foreign key(id_produit) references _produit(id_produit) on delete cascade,
      constraint _reassort_fk_vendeur foreign key(id_vendeur) references _vendeur(id_vendeur) on delete cascade
  );
...
create table _promotion(
    ...
    descrip_promotion varchar(100) not null,
    date_debut date not null,
    date_fin date not null,
    banniere_promo varchar(100) not null,
...
CREATE TABLE _livraison (
    ...
    date_exped_transporteur date,
    date_arrive_transporteur date,
    date_exped_plateforme date,
    date_arrive_plateforme date,
    date_exped_centreLocal date,
    date_arrive_centreLocal date,
    date_exped_domicile date,
    date_arrive_domicile date,
    date_livraison_reel date,
    etape int,
    statut VARCHAR(100),
    raison_refus VARCHAR(50),
    signature_livraison boolean,
    CONSTRAINT _livraison_pk PRIMARY KEY (bordereau)
);
...
WHERE statut_commande = 'En attente de paiement';
...
create table _notification (
    ...
    constraint _notification_fk_compte foreign key (id_compte) references _compte(id_compte)
);
...
ALTER TABLE _commande 
    ...
    ADD CONSTRAINT _commande_fk_client FOREIGN KEY (id_client) REFERENCES _client(id_client),
    ADD CONSTRAINT _commande_fk_adresseLivraison FOREIGN KEY (id_livraison) REFERENCES _adresse(id_adresse),
    ADD CONSTRAINT _commande_fk_adresseFacturation FOREIGN KEY (id_facturation) REFERENCES _adresse(id_adresse);
...
('defaultImg', 'media/profils/', '.jpg', 'photo profil client 1'),
('defaultImg', 'media/profils/', '.jpg', 'photo profil client 2'),
('defaultImg', 'media/profils/', '.jpg', 'photo profil client 3'),
('defaultImg', 'media/profils/', '.jpg', 'photo profil client 4'),
('defaultImg', 'media/profils/', '.jpg', 'photo profil client 5'),
('defaultImg', 'media/profils/', '.jpg', 'logo vendeur 1'),
('defaultImg', 'media/profils/', '.jpg', 'logo vendeur 2'),
('defaultImg', 'media/profils/', '.jpg', 'logo vendeur 3'),
...
-- ============================================================
-- 2. PEUPLEMENT DES COMMANDES (Liées aux adresses)
-- ============================================================
INSERT INTO _adresse (ville, complement_adresse, code_postal, num_rue, nom_rue, id_client, id_vendeur, type) VALUES

('Quimper', 'Zone Artisanale', '29000', 12, 'Rue de la Terre', NULL, 6, 'Professionnelle'),
('Saint-Malo', 'Bâtiment B', '35400', 45, 'Avenue de la Mode', NULL, 7, 'Professionnelle'),
('Rennes', 'Étage 2, Porte 4', '35700', 8, 'Boulevard du Numérique', NULL, 8, 'Professionnelle'),

('Brest', 'Résidence Océan', '29200', 3, 'Rue de Siam', 1, NULL, 'Domicile'),

('Lorient', '', '56100', 22, 'Place Jules Ferry', 2, NULL, 'Domicile'),

('Vannes', 'Appt 12', '56000', 14, 'Rue Thiers', 3, NULL, 'Domicile'),

('Saint-Brieuc', '', '22000', 56, 'Boulevard Clémenceau', 4, NULL, 'Domicile'),

('Dinan', 'Maison rouge', '22100', 9, 'Rue du Jerzual', 5, NULL, 'Domicile');
INSERT INTO _commande
(num_commande, frais_livraison, montant_total_ht, statut_commande, date_commande, total_nb_prod, montant_total_ttc, id_client, id_livraison, id_facturation)
VALUES
-- Client 1 utilise l'adresse 4
(1, 4.90, 26.7, 'Livraison', CURRENT_DATE - INTERVAL '14 days', 5, (26.7 * 1.2) + 4.90, 1, 4, 4),
-- Client 2 utilise l'adresse 5
(2, 6.00, 38.5, 'Archivée', CURRENT_DATE - INTERVAL '10 days', 5, (38.5 * 1.2) + 6.00, 2, 5, 5), 
-- Client 3 utilise l'adresse 6
(3, 5.90, 52.4, 'Livraison', CURRENT_DATE - INTERVAL '8 days', 4, (52.4 * 1.2) + 5.90, 3, 6, 6), 
-- Client 4 utilise l'adresse 7
(4, 4.50, 61.0, 'Livraison', CURRENT_DATE - INTERVAL '5 days', 3, (61.0 * 1.2) + 4.50, 4, 7, 7), 
-- Client 5 utilise l'adresse 8
(5, 6.00, 29.5, 'En attente de paiement', CURRENT_DATE - INTERVAL '3 days', 3, (29.5 * 1.2) + 6.00, 5, 8, 8), 
-- Autres commandes...
(6, 4.90, 44.0, 'Livraison', CURRENT_DATE - INTERVAL '12 days', 4, (44.0 * 1.2) + 4.90, 2, 5, 5), 
(7, 7.00, 95.0, 'Livraison', CURRENT_DATE - INTERVAL '6 days', 5, (95.0 * 1.2) + 7.00, 3, 6, 6), 
(8, 5.50, 73.0, 'Livraison', CURRENT_DATE - INTERVAL '15 days', 2, (73.0 * 1.2) + 5.50, 3, 6, 6), 
(9, 6.50, 83.0, 'Livraison', CURRENT_DATE - INTERVAL '15 days', 4, (83.0 * 1.2) + 6.50, 4, 7, 7), 
(10, 3.90, 63.0, 'Livraison', CURRENT_DATE - INTERVAL '4 days', 3, (63.0 * 1.2) + 3.90, 5, 8, 8), 
-- Paniers actifs (En cours)
(12, 5.00, 15.0, 'Livraison', CURRENT_DATE, 1, 18.00, 2, 5, 5),
(13, 5.00, 15.0, 'Livraison', CURRENT_DATE, 1, 18.00, 3, 6, 6),
(14, 6.50, 83.0, 'Livraison', CURRENT_DATE, 1, 99.00, 4, 7, 7),
(15, 6.00, 29.5, 'Livraison', CURRENT_DATE, 1, 35.50, 5, 8, 8);
...
-- Nettoyage préalable
TRUNCATE TABLE _promotion, _remise RESTART IDENTITY CASCADE;

-- ============================================================
-- 1. INSERTION DES PROMOTIONS (Campagnes Marketing)
-- ============================================================

INSERT INTO _promotion (id_produit, nom_promotion, descrip_promotion, date_debut, date_fin, banniere_promo) VALUES
(56, 'Soldes d''Hiver', 'Profitez de -20% sur la mode marine !', CURRENT_DATE,CURRENT_DATE + INTERVAL '1 month', 'produit56_1.jpg'),
(3, 'Pause Gourmande', 'Le Kouign-amann à prix réduit pour le goûter.', CURRENT_DATE, CURRENT_DATE + INTERVAL '5 days', 'produit3_1.png'),
(104, 'Déstockage Art', 'Grande liquidation sur les posters limités.', CURRENT_DATE, CURRENT_DATE + INTERVAL '15 days', 'produit104_1.png'),
(6, 'Douceur Salée', 'Offre spéciale sur le caramel au beurre salé.', CURRENT_DATE, CURRENT_DATE + INTERVAL '1 week', 'produit6_1.jpg'),
(110, 'Tech Days', 'Réduction exclusive sur la déco gaming.', CURRENT_DATE, CURRENT_DATE + INTERVAL '3 days', 'produit110_1.png'),

(109, 'Nouveauté HeroLeague', 'Découvrez notre nouvelle collection de sweats.' , CURRENT_DATE, CURRENT_DATE + INTERVAL '1 month', 'produit109_1.jpg'),
(21, 'L''Excellence Bretonne', 'Le Whisky Kornog élu meilleur produit du mois.', CURRENT_DATE, CURRENT_DATE + INTERVAL '10 days', 'produit21_1.jpg'),
(63, 'Idée Cadeau', 'Offrez un bijou triskell pour les fêtes.', CURRENT_DATE, CURRENT_DATE + INTERVAL '20 days', 'produit63_1.png');

-- ============================================================
-- 2. INSERTION DES REMISES (Réductions financières)
-- Seuls les produits des "Cas A" ci-dessus ont une remise associée.
-- Les valeurs sont calculées sur les prix HT définis dans la table _produit.
-- ============================================================
TRUNCATE _remise CASCADE;
INSERT INTO _remise (taux_remise, id_produit) VALUES
(0.20, 56),
(0.10, 3),
(0.50, 104),
(0.15, 6),
...
FROM _produit;
-- ==============================
-- 1. PEUPLEMENT COORDONNÉES BANCAIRES
-- (Nécessaire pour lier les paiements)
-- ==============================
INSERT INTO _coordonnees_banquaire (id_coord, numero_cb_masque, nom_porteur, cryptogramme, date_exp_cb, id_client) VALUES
(1, 'XXXX-XXXX-XXXX-1111', 'DUPONT Claire', '123', CURRENT_DATE + INTERVAL '2 years', 1),
(2, 'XXXX-XXXX-XXXX-2222', 'LEFEVRE Marc', '456', CURRENT_DATE + INTERVAL '1 year', 2),
(3, 'XXXX-XXXX-XXXX-3333', 'BERNARD Thomas', '789', CURRENT_DATE + INTERVAL '3 years', 3),
(4, 'XXXX-XXXX-XXXX-4444', 'JOLY Lucie', '321', CURRENT_DATE + INTERVAL '6 months', 4),
(5, 'XXXX-XXXX-XXXX-5555', 'MARTIN François', '654', CURRENT_DATE + INTERVAL '2 years', 5);

-- ==============================
-- 2. PEUPLEMENT PAIEMENTS
-- (Généré automatiquement pour les commandes validées)
-- ==============================
INSERT INTO _paiement (id_coord, num_commande, montant_ttc)
SELECT 
    cb.id_coord,
    c.num_commande,
    c.montant_total_ttc
FROM _commande c
JOIN _coordonnees_banquaire cb ON c.id_client = cb.id_client
WHERE c.statut_commande NOT IN ('En attente de paiement', 'En préparation');

-- ==============================
-- 3. PEUPLEMENT FACTURES
-- (Une facture pour chaque commande payée)
-- ==============================
INSERT INTO _facture (date_facture, montant_facture, num_commande)
SELECT 
    c.date_commande, 
    c.montant_total_ttc, 
    c.num_commande
...
SELECT setval('_adresse_id_adresse_seq', (SELECT MAX(id_adresse) FROM sae._adresse));
...
SELECT setval('_coordonnees_banquaire_id_coord_seq', (SELECT MAX(id_coord) FROM sae._coordonnees_banquaire));
